...
* [vue2-google-maps](#vue2-google-maps)
   ...
   * [Classes](#classes)
      * [load(apiKey: string, version: string, libraries: string[]) : void](#loadapikey-string-version-string-libraries-string--void)
      * [load(options: {[key: string]: [string]}) : void](#loadoptions-key-string-string--void)
